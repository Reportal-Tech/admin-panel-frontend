...
export async function addNewVilla(formData: FormData, builderId: string) {
  ...
  try {
    const villaAddResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/createVilla`,
      {
        method: 'POST',
        headers: {
...
export async function addNewPlot(formData: FormData, builderId: string) {
  ...
  try {
    const plotAddResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/createPlot`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
...
export async function addNewApartment(formData: FormData, builderId: string) {
  ...
  try {
    const apartmentAddResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/createApartment`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
...
export async function updateBuilderWithProject(
  projectType: 'plot' | 'apartment' | 'villa',
  builderId: string,
  projectId: string
) {
  const authToken = await getAuthToken();
...
export async function fetchAllAdminPlots() {
  ...
  try {
    const plotsResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/getAllAdminPlots`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${authToken}`,
...
export async function fetchAllAdminVillas() {
  ...
  try {
    const villasResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/getAllAdminVillas`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${authToken}`,
...
export async function fetchAllAdminApartments() {
  ...
  try {
    const apartmentsResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/getAllAdminApartment`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${authToken}`,
...
export async function fetchAdminSingleProjectDetails(
  projectId: string,
  projectType: 'apartment' | 'plot' | 'villa'
) {
  const authToken = await getAuthToken();
  ...
  const queryString =
    projectType === 'apartment'
      ? `getAdminApartmentDetails/${projectId}`
      : projectType === 'plot'
      ? `getAdminPlotDetails/${projectId}`
      : `getAdminVillaDetails/${projectId}`;

  try {
    const adminSingleProjectDetails = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/${queryString}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${authToken}`,
...
export async function deleteAdminProject(
  ...
  const queryString =
    projectType === 'apartment'
      ? `deleteAdminApartment/${projectId}`
      : projectType === 'plot'
      ? `deleteAdminPlot/${projectId}`
      : `deleteAdminVilla/${projectId}`;

  try {
    const deleteSingleProject = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/${queryString}`,
      {
        method: 'DELETE',
        headers: {
...
export async function editAdminProjectById(
  formData: FormData,
  projectId: string,
  projectType: 'apartment' | 'plot' | 'villa'
) {
  ...
  const queryString =
    projectType === 'apartment'
      ? `updateAdminOwnApartment/${projectId}`
      : projectType === 'plot'
      ? `updateAdminOwnPlot/${projectId}`
      : `updateAdminOwnVilla/${projectId}`;

  try {
    const editSingleResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/${queryString}`,
      {
        method: 'PATCH',
        headers: {
...
export async function fetchAllBuilderProjects() {
  ...
  try {
    const allBuilderProjectsResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/getBuilderProjects`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${authToken}`,
...
export async function updateBuilderProjectStatus(
  ...
  try {
    const updateProjectStatusResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/v1/admin/updateBuilderProjectStatus/${projectId}`,
      {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
